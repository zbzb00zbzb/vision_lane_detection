# copied from caffe/cmake/lint.cmake

set(CMAKE_SOURCE_DIR ${PROJECT_SOURCE_DIR})
set(LINT_COMMAND ${CMAKE_SOURCE_DIR}/scripts/cpp_lint.py)

set(LINT_COMMAND_ARGS "--filter=-whitespace/braces,-build/header_guard")

set(SRC_FILE_EXTENSIONS h hpp c cpp cc)
set(LINT_DIRS include src test 3rdparty/cnn)
...
execute_process(
    COMMAND ${LINT_COMMAND} ${LINT_COMMAND_ARGS} ${LINT_SOURCES}
